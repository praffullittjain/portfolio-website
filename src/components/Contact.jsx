    ...
    <section id="contact" className="bg-white py-24 px-6">
      <div className="max-w-xl mx-auto text-center">
        ...
        <p className="text-gray-600">
          Open to Product Manager and Technical PM roles in London.
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            ...
            className="rounded-lg border border-sage px-5 py-2.5 text-sm font-semibold text-sage hover:bg-sage hover:text-white transition-colors"
          >
            Download CV
          </a>
        </div>
